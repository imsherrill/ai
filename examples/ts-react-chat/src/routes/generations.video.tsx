        ...
        <div className="max-w-2xl mx-auto space-y-6">
          <div className="p-4 bg-yellow-500/10 border border-yellow-500/20 rounded-lg">
            <p className="text-yellow-400 text-sm">
              Video generation is experimental and requires Sora API access in
              your OpenAI account. Generation can take several minutes.
            </p>
          </div>
            ...
            <div className="p-4 bg-gray-800/50 border border-gray-700 rounded-lg space-y-3">
              ...
              {videoStatus && (
                <>
                  <p className="text-sm text-gray-400">
                    Status:{' '}
                    <span className="text-white">{videoStatus.status}</span>
                  </p>
